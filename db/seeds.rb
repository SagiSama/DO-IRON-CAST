...
News.create([{ title: 'title', subject: 'subject', status: News.statuses[:enable] }])
Performance.create([{ title: 'title', subject: 'subject', period: '12 month', status: News.statuses[:enable] }])
